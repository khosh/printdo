...
//        .project,.context{float:left;margin-right:10px;}
	...
	body{font-size:12px;font-family: 'lucida Grande',Tahoma,Arial;}\
        ...
        .project,.context{float:right;margin-right:10px;}\
    ...
    newwindo.document.write('<div id="print"><h1 id="title"></h1><div id="printthis"><a href=javascript:print();>[Print this page]</a></div>'
        + doit_wrap.html() + '<div id="copyright">Copyright © 2011 @leeiio(http://leeiio.me), All Rights Reserved</div></div>');
